...
public class MainActivity extends ListActivity {
	...
	String[] ActivityNames = {
			"simplesql.TestDatabaseActivity"
			,"content.ContactsViewActivity"
			,"content.TodosOverviewActivity"
	};
	...
	protected void onListItemClick(ListView list, View view, int position, long id) {
		...
		try {
			Class targetActivity = Class.forName("com.example.playvogellatwo." + activityName);
